...
p1 <- p1 + geom_point(size = 2.5) +
    ...
    labs(x = "Mean Accuracy Correct",
         ...
         subtitle = "Showing the relation between all the correct responds for accuracy and high confidence per light direction degree",
...
p2 <- p2 + geom_point(size = 2.5) +
    ...
    labs(x = "Mean Accuracy Correct",
         ...
         subtitle = "Showing the relation between all the correct responds for accuracy and low confidence per light direction degree",
         color = "Light Direction Degree") +
    theme(legend.position = "top")
...
p3 <- ggplot(accu_confi, aes(x = pct_accu_right, y = pct_high_confi, label = light_dir))
p3 <- p3 + geom_point(size = 2.5, alpha = .07, color = "gray50") +
...
p4 <- ggplot(accu_confi, aes(x = pct_accu_right, y = pct_low_confi, label = light_dir))
p4 <- p4 + geom_point(size = 2.5, alpha = .07, color = "gray50") +
    geom_jitter(size = 2.5, alpha = .07, color = "gray50") +
...
# Copies of all plots to use them in a grid
p5 <- p1
p6 <- p2
p7 <- p3
p8 <- p4

# Removing elements to build a grid
p5 <- p5 + labs(title = "", subtitle = "") + theme(legend.position = "none")
p6 <- p6 + labs(title = "", subtitle = "") + theme(legend.position = "none")
p7 <- p7 + labs(title = "", subtitle = "") + theme(legend.position = "none")
p8 <- p8 + labs(title = "", subtitle = "") + theme(legend.position = "none")
